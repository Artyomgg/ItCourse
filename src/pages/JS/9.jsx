	...
	return (
      ...
      web-share'
				...
				<div className='block-code'>
					<img src='/public/img/course/js-img/Screenshot_19.png' alt='' />
				</div>
				<button
					className='btn1 red'
				...
				<div className='block-code'>
					<img src='/public/img/course/js-img/Screenshot_20.png' alt='' />
				</div>
				<button
					className='btn1 red'
				...
				<div className='block-code'>
					<img src='/public/img/course/js-img/Screenshot_21.png' alt='' />
				</div>
				<button
					className='btn1 red'
