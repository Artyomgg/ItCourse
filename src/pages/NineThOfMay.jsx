		...
		<div className='victory-day-container'>
			...
			<div className='victory-day-content'>
				...
				<h2 className='victory-day-subtitle'>
					Сегодня мы вспоминаем героев, отдавших жизнь за нашу свободу. Почтите
					их память минутой молчания.
				</h2>

				{/* Вкладка с заданием */}
				<div className='assignment-tab'>
					<div className='tab-header'>О событии</div>
					<p className='event-end'>Проходите задания которые начнут появляться с 8 мая.</p>
					<br />
