...
import { TopicsDataSevenClass } from '../../../../Data/LessonsData.js'

function TopicsSev(props) {
	const { topicId } = useParams()	
	const navigate = useNavigate();
  const [isLoading, setIsLoading] = useState(true);

	const currentTopic = TopicsDataSevenClass[topicId]
  ...
  const handleBack = () => {
    navigate('/courses/forschool/home/7');
  };
