...
import { topicsData } from '../../../../Data/LessonData/9Class/TopicsData.js'
import { useState } from 'react'

const LessonRendererNi = () => {
                    ...
                    <div className='images'>
                        ...
                        <div className='images-grid'>
                            {lessonContent.image.map((imgSrc, index) => (
                                <img
                                    key={index}
                                    src={`/img/course/forschool/9/${imgSrc}`}
                                    alt={`Иллюстрация ${index + 1}`}
                                    className='lesson-image'
                                    onClick={() => openModal(`/img/course/forschool/9/${imgSrc}`)}
                                />
                            ))}
                        </div>
                    </div>
...
export default LessonRendererNi